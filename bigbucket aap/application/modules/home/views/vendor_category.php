                    ...
                    <div class="row">
                     ...
                     <div class="wrap" id="ad-select">
                        <div class="row text-center">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pdng-rgt">
                               <div class="form-group" id="search_name"><!-- 
                                  <label class="label-deco label-whte" style="color:white;">I am looking for:</label> -->
                                 
                                  <select class="form-control add-post-frm bck-img" name="category" id="cat_id">
                                    
                                       <option >Select Vendor</option>
                                    <?php foreach($category as $key => $val){ ?>
                                        <option value="<?php echo $val['id'];?>" <?php if(!empty($cat_id) AND !empty($val['id']) AND $cat_id == $val['id']){echo "selected";}?>>
                                            <?php echo $val['name'];?>  
                                        </option>
                                    <?php }?>
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pdng-rgt pdng-lft">
                                <!-- <label class="label-deco label-whte" style="color:white;">In:</label> -->
                                <div class="search">
                                    <input type="text" class="searchTerm vendor-search inpt-rel" name="address" id="address_google" placeholder="Enter location" />
                                    <input type="hidden" id="fbUserLocLat" name="fbUserLocLat">
                                    <input type="hidden" id="fbUserLocLong" name="fbUserLocLong">
