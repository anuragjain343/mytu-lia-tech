  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
              <a href="<?php echo base_url();?>home/users/vendorList" class="btn thms-btn"><i class="fa fa-arrow-left"></i></a>
            </div>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">            
            ...
            <div class="prfle-img-info">
              ...
              <div class="vndr-prfl-cht-rate vndr-prfl-cht-rate-mble rte-res-str">
                ...
                <div class="chat-option cmnt-img1">
                    <?php if(empty($this->session->userdata('id'))){ ?>
                        <a id="ShowSingup" class="page-scroll" data-toggle="modal" data-target="#check_login_modal" href="#"><img src="<?php echo $frontend_assets ?>img/chat-2.png" alt="" width="30px"></a>
                    <?php }else{ ?>
                        <a href="#" onclick="changeChatUser(<?php echo $vendor_data->id; ?>)" data-id="<?php echo $vendor_data->id; ?>" data-toggle="modal" data-target="#ChatModal"><img src="<?php echo $frontend_assets ?>img/chat-2.png" alt="" width="30px">
                    <?php }?>
                </div>
