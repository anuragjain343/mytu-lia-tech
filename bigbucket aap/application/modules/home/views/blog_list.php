...
<?php } }?>
 ...
 <?php if(!empty($blogList) && count($blogList)>3){ ?> 
<div style="clear: both"></div>
<div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-4">
    <div class="login-snd ">
        <a href="<?php echo base_url();?>home/imaginations"><button type="button" class="m-btn login-btn block-btn load_more_btn center-block"  >Read More</button></a>
    </div>
</div>
