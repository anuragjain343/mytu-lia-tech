...
class Home extends FrontCommon_Controller {
   ...
   function blogList2(){
        ...
        if($is_next){
            $id = "btnLoadViewMe1";
            $btn_html   = '<div class="login-snd "><button type="button" class="m-btn login-btn block-btn load_more_btn center-block" id = "'.$id.'" data-offset ="'.$new_offset.'" data-isNext ="'.$is_next.'">Read More</button></div>';
        }
        //load view with data
