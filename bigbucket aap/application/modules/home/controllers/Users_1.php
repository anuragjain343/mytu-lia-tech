...
class Users extends FrontCommon_Controller {
    ...
    { //pr($_POST);
        ...
        $total = $this->common_model->search_user_list_count('vendor', $category_id, $lat,$long,$check_status=true,$user_id); 
       ...
       // echo $user_id;
        $data['vendor_list']     = $this->common_model->search_user_list('vendor', $category_id, $lat,$long, $limit, $offset, $check_status=true,$user_id); 
