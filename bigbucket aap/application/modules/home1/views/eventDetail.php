          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="profile-evnt-detl">
                ...
                <div class="prfle-evnt-nme">
                  ...
                  <p><?php echo $data->email; ?> | <?php echo $data->contact_number; ?></p>
               ...
               <!--i am doing this evnt-->
                ...
                <?php } ?>
                <div class="edit-dlte-mypst-dtl1 evnt-dtl">
                    <a href="javascript:void(0)" onclick="changeChatUser(<?php echo $data->post_author; ?>)" data-id="<?php echo $data->post_author?>" data-toggle="modal" data-target="#ChatModal"><img src="<?php echo $frontend_assets ?>img/chat-3.png" alt="" width="30px"><div class="vndr-cmnt vndr-cmnt-img">
