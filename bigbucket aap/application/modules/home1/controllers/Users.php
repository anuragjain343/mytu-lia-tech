...
class Users extends FrontCommon_Controller {
    ...
    function vendor_cat_list()
    {
       ...
       // $total = $this->common_model->search_user_list_count('vendor', $category_id, $search_name,$check_status=true);
         if(!empty($this->session->userdata('id'))){
            $user_id = $this->session->userdata('id');
            $total = $this->common_model->search_user_list_count('vendor', $category_id, $search_name,$check_status=true,$user_id);
        ...
        if(!empty($this->session->userdata('id'))){
            $user_id = $this->session->userdata('id');
            $data['vendor_list']     = $this->common_model->search_user_list('vendor', $category_id, $search_name, $limit, $offset, $check_status=true,$user_id);
        }else{
            $data['vendor_list']     = $this->common_model->search_user_list('vendor', $category_id, $search_name, $limit, $offset, $check_status=true,$user_id='');
        } 
    ...
    function realated_vendor()
    {
        ...
        // $data['realated_vendor'] = $this->common_model->related_vendor('vendor',$vendor_id, $category_id,$check_status=true); 
         if(!empty($this->session->userdata('id'))){
            $user_id = $this->session->userdata('id');
            $data['realated_vendor'] = $this->common_model->related_vendor('vendor',$vendor_id, $category_id,$check_status=true,$user_id); 
        }else{
            $data['realated_vendor'] = $this->common_model->related_vendor('vendor',$vendor_id, $category_id,$check_status=true,$user_id='');
        }
