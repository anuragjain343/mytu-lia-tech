        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
               <?php if($userDetail->userType == 'vendor'){ ?>  
              <div class="certif_icon text-right">
                
                <?php if(!empty($features_users_id->user_id)){ 
                  $title = 'Removed featured vendor'; } else{
                    $title = 'Add as featured vendor';  
                  }
                  ?>
                <a href="javascript:void(0);" title = "<?php echo $title;?>" id="colorChange" style="<?php if(!empty($features_users_id->user_id)){  echo "color:green;";}else{ echo "color:gray;"; }?>""   onclick="addfeatursUser('<?php echo $userDetail->id; ?>');" > 

    
                  <i class="fa fa-certificate" id="mainIconRed" ></i>
                 </a>
              </div>
               <?php }?>
              ...
              <span style="font-size: 2em; color: green; margin-left: 130px;">
