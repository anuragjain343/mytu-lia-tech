  ...
  <div class="container">
   ...
   <ul class="nav navbar-nav MainMenu">
            ...
            <?php if(!empty($this->session->userdata('id'))){ ?>
                ...
                <li><a class="page-scroll" href="<?php echo base_url();?>home/imaginations">Imaginations</a></li>
               ...
               <!--  <li class="dropdown">
                ...
                <?php } else{ ?>
                <li><a class="page-scroll"  href="<?php echo base_url();?>#imaginations">Imaginations</a></li>
                <li><a class="page-scroll" href="<?php echo base_url();?>#features">Features</a></li>
                <li class="dropdown">
                    <a class="page-scroll dropdown-toggle" href="javascript:void(0);" data-toggle="dropdown">Socialize<span class="caret"></span></a> 
                    <ul class="dropdown-menu">
