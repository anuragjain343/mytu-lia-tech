...
<script>
  ...
  var config = {
    apiKey: "AIzaSyDZHPGEshXmhxxbSfkyb4VKJjPHGKdyEJg",
    authDomain: "dev-tulia.firebaseapp.com",
    databaseURL: "https://dev-tulia.firebaseio.com",
    projectId: "dev-tulia",
    storageBucket: "dev-tulia.appspot.com",
    messagingSenderId: "237486688454"
  };
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       ...
       <li class="<?php echo (strtolower($this->router->fetch_class()) == "events") ? "active" : "" ; ?>" >
        ...
        <li class="<?php echo (strtolower($this->router->fetch_class()) == "Imaginations") ? "active" : "" ; ?>" >
          <a href="<?php echo site_url('admin/imaginations'); ?>">
            <i class="fa fa-rss"></i> <span>Imaginations</span>
          </a>
        </li>

        <li class="<?php echo (strtolower($this->router->fetch_class()) == "Chat") ? "active" : "" ; ?>" >
