                ...
                if (oneMsg.deleteby != myId) {
                    ...
                    if (oneMsg.op_id == myId) {
                        if (oneMsg.imageURL != '') {
                            ...
                            $('.paginationChat').append('<div id=' + key + ' class="row message-body"> <div class="message-main-sender"> <div class="sender"> <div class="message-text1"><xmp>' + showMsg + '</xmp></div></div><div class="clearfix"></div><p id=' + skey + ' class="message-time pull-right hover-time"> ' + time + ' </p> </div></div>');
                        }
                    } else {
                        if (oneMsg.imageURL != '') {
                            ...
                            $('.paginationChat').append('<div id=' + key + ' class="row message-body"> <div class="message-main-receiver"> <div class="receiver"> <div class="message-text"><xmp>' + showMsg + '</xmp></div></div><div class="clearfix"></div><p id=' + skey + ' class="message-time1 hover-time"> ' + time + ' </p></div></div> ');
                        }
                    }
                } else {
                    runPagination = 0;
            ...
            if (oneMsg.deleteby != myId) {
                ...
                if (oneMsg.op_id == myId) {
                    if (oneMsg.imageURL != '') {
                        ...
                        $('.message').append('<div id=' + snapshot.key + ' class="row message-body"> <div class="message-main-sender"> <div class="sender"> <div class="message-text"><xmp>'+ showMsg + '</xmp> </div></div><div class="clearfix"></div><p id='+skey+' class="message-time pull-right hover-time"> ' + time + ' </p> </div></div>');
                    }
                } else {
                    ...
                    if (oneMsg.imageURL != '') {
                        ...
                        $('.message').append('<div id=' + snapshot.key + ' class="row message-body"> <div class="message-main-receiver"> <div class="receiver"> <div class="message-text"> <xmp>' + showMsg + '</xmp> </div></div><div class="clearfix"></div><p id='+skey+' class="message-time1 hover-time"> ' + time + ' </p> </div></div>');
                    }
                }
                $('.message').animate({
    ...
    function changeChatUser(op_id) { 
        ...
        $.ajax({
                ...
                success: function(data){  
                    ...
                    if(data['id'] == '1'){
                        $('#op_chat_name').val('Admin');
                        $('#op_chat_image').val(base_url+'backend_asset/custom/images/tulia_logo_40x40.png');
                    }else{
