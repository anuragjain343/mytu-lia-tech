<?php
/**
* Handles image upload and resizing and cropping
* version: 2.0 (14-08-2018)
*/

class ImageCrop_model extends CI_Model{
    ...
    function image_sizes($folder){
        ...
        switch($folder){
            case 'user_album' :
                $img_sizes['thumbnail'] = array('width'=>320, 'height'=>213, 'folder'=>'/thumb');
    ...
    //resize already uploaded images
    function resize_n_crop($image_data, $folder, $path=FALSE ){
        ...
        //We will now resize and crop this image 
        $this->load->library('image_lib'); //Load image manipulation library
        $thumb_img = '';
    ...
    function canvasImageUpload($img, $folder){
