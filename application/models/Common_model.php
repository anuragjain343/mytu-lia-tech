...
class Common_model extends CI_Model {
    ...
    function search_user_list1($user_type, $category_id, $search_str,  $limit, $offset=3, $check_status=true,$user_id ='',$latitude='',$longitude=''){
    ...
    function search_user_list($user_type, $category_id,$cat, $lat,$long,$limit, $offset=3, $check_status=true,$user_id =''){
            ...
            if(empty($lat) AND empty($long)){
             // $latitude= $userlt['latitude'];
              ...
              /*if(empty($letitud) AND empty($letitud)){
                $latitude= $userlt['latitude'];
                $longitude = $userlt['longitude'];
             // pr($latitude);
            }*/
