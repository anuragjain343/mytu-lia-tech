   ...
   // CKEDITOR.replace('editor1');
    ...
    // to register user's in firebase db
      function authUser(){
        ...
        var userObj = {
            "category" : '',
            "email" : 'admin@dev.tulia.tech',
            "firebaseId" : "",
            "firebaseToken" :"",
            "name" : 'Admin',
            "profilePic" : '<?php echo base_url().'backend_asset/custom/images/tulia_logo_40x40.png';?>',
            "uid" : '1'.toString(),
            "userType" : 'user'
      } 
      firebase.database().ref("users").child('user').child('1').set(userObj);
