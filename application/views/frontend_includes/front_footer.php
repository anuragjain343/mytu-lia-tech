      ...
      <div class="modal-body">
        <div class="signupSection">
          <div class="signupLeft">
            ...
            <!--   <form class="login-form" method="POST" id="registration_form" role="form" action="<?php  ?>">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">                   
                    <div class="row mr-minus">                            
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group lin-hgt">    
                          <label class="fnt-wt">Code</label>               
                          <select class="form-control add-post-frm" name="countryCode" id="countryCode">
                            <option value="">Select code</option>
                            <?php 
                            $url = APPPATH.'third_party/country_code.json'; 
                ...
                <div class="facebook-link">
                    <div id="status"></div>
                    <a href="#" onclick="fbLogin()" id="fbLink1"><span class="icon fa fa-facebook"></span>SIGN UP WITH FACEBOOK</a>
                    <div id="userData"></div>
                </div>
    ...
    <div class="row">
            <div class="display-inlne-block">
               ...
               <div class="float-rgt-sec">
                   <div class="foot-img"><a href="<?php echo base_url();?>"><img src="<?php echo $frontend_assets ?>img/logo02.png"><img class="img-top" src="<?php echo $frontend_assets ?>img/logo03.png"></a></div>
               </div>
            </div>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog frgt-pswd" role="document" style="margin: 10px auto;">
        <div class="modal-content">
            <div class="modal-header bg-img">
                <div class="details-head" id="showTitle">
            ...
            <div class="modal-body modal-frgt-body">
              ...
              <div class="modal-footer brdr-top">
                <button data-dismiss="modal" type="button" class="m-btn pull-right" >Close</button>
              </div>      
        </div>
    </div>
</div>
...
<div class="modal fade" id="ModalNotification" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog frgt-pswd" role="document" style="margin: 10px auto;">
        <div class="modal-content">
            ...
            <div class="modal-body modal-frgt-body">
              <p id="notificationDetail"><h3></h3></p>
            </div><!--/modal-frgt-body-->
              <div class="modal-footer brdr-top">
                <button data-dismiss="modal" type="button" class="m-btn pull-right" >Close</button>
              </div>      
