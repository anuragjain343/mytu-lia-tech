...
define('COPYRIGHT','Copy Right © By Tulia 2017-18 | All Rights Reserved.');
...
define('ALBUM_ATTACHMENTS', 'album_attachments');
define('NOTIFICATIONS', 'notifications');
define('CONTENT','page_content');
define('FEEDBACK', 'feedback');
define('BLOG', 'blogs');
define('FEATURE_USERS', 'features_users');
...
define('BLOG_CONTENT','uploads/blog/');


//firebase database credencial constance
switch (ENVIRONMENT) {
    case 'development': 
        define('API_KEY', 'AIzaSyDZHPGEshXmhxxbSfkyb4VKJjPHGKdyEJg');
        define('AUTH_DOMAIN', 'dev-tulia.firebaseapp.com');
        define('DB_URL', 'https://dev-tulia.firebaseio.com');
        define('PROJECT_ID', 'dev-tulia');
        define('STORAGE_BUCKET', 'dev-tulia.appspot.com');
        define('MSG_SENDER_ID', '237486688454');
    break;
    case 'production':
        define('API_KEY', 'AIzaSyDXppi4rb-OCK5BXuwSFhHlmh-ug6VKjvE');
        define('AUTH_DOMAIN', 'tulia-3e45f.firebaseapp.com');
        define('DB_URL', 'https://tulia-3e45f.firebaseio.com');
        define('PROJECT_ID', 'tulia-3e45f');
        define('STORAGE_BUCKET', 'tulia-3e45f.appspot.com');
        define('MSG_SENDER_ID', '301086763024');
