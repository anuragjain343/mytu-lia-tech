    ...
    e.preventDefault();
     cat_id = $('#cat_id').val();
      ...
      if(cat_id=='Select Vendor' && address_google==='') {
         var  current_url =  "http://localhost/dev_tulia/home/users/vendorList";
      }
      else if(cat_id === ' ' || cat_id=='Select Vendor') {
        var  current_url =  "http://localhost/dev_tulia/home/users/vendorList?location="+address_google+ "&lat="+fbUserLocLat+ "&long="+fbUserLocLong;
       
      }
      else if(address_google==='' ){
      var  current_url =  "http://localhost/dev_tulia/home/users/vendorList?id="+cat_id;

      }
       
      else{
        var  current_url =  "http://localhost/dev_tulia/home/users/vendorList?id="+cat_id+ "&location="+address_google+ "&lat="+fbUserLocLat+ "&long="+fbUserLocLong;
