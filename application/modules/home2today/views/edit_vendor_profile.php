                                ...
                                <div class="row">               
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="latitude" name="latitude"  value="<?php echo $userData->latitude ?>" />
                                            <input type="hidden" id="longitude" name="longitude"  value="<?php echo $userData->longitude ?>"/>
                                        </div>
                                    </div>
                                </div>
                                <!--email id-->
