...
class Home_model extends CI_Model {
    ...
    function getRandomVendor($user_type){
		...
		$this->db->join(FEATURE_USERS. ' as fu', "fu.user_id = u.id","right");
    ...
    function getBlogs($data){
    	...
    	$this->db->join(ATTACHMENTS. ' as att ',"b.blogId = att.reference_id AND att.image_size = 'default' AND att.reference_table ='blogs'");
    	$this->db->from(BLOG.' as b');
	    $this->db->limit($data['limit'], $data['offset']);
	    $this->db->group_by('att.reference_id');
