      ...
      <div class="container">
        <div class="row">
          <div class="lead-o col-lg-6 col-xm-12">
            ...
            <br>
           <a href="https://itunes.apple.com/in/app/TuliA/id1338181586?mt=8&ign-mpt=uo%3D4" target="_blank"><img src="<?php echo $frontend_assets ?>img/app-store.png" alt="" class="mb10"></a>&nbsp;&nbsp;<a href="https://play.google.com/store/apps/details?id=com.tulia" target="_blank"><img src="<?php echo $frontend_assets ?>img/play-store.png" alt="" class="mb10"></a>  </div>
                    ...
                    <?php 
                        ...
                        <div class="col-md-<?php echo $i; ?> col-sm-<?php echo $i; ?> col-xs-12" >
                           <!--  <a class="category-card category-venue" href="<?php echo site_url(); ?>home/users/vendorList/<?php echo encoding($val->id); ?>"> -->
                            <a class="category-card category-venue" href="<?php echo site_url();?>home/users/vendorList?id=<?php echo encoding($val->id);?>&location=<?php echo $login_user->address;?>&lat=<?php echo $login_user->latitude;?>&long=<?php echo $login_user->longitude;?>">
    ...
    <div class="container">
      <div class="row">
        <div class="lead col-lg-7 col-lg-offset-3 col-xm-offset-0 col-xm-12 text-center download-back ">
          ...
          <a href="https://itunes.apple.com/in/app/TuliA/id1338181586?mt=8&ign-mpt=uo%3D4" target="_blank"><img src="<?php echo $frontend_assets ?>img/app-store.png" alt=""></a><a href="https://play.google.com/store/apps/details?id=com.tulia" target="_blank"><img src="<?php echo $frontend_assets ?>img/play-store.png" alt=""></a> </div>
      </div>
    </div>
  </div>
</div>
