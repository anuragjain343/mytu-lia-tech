            ...
            <div class="profile-evnt-detl">
               ...
               <!--i am doing this evnt-->
                ...
                <div class="edit-dlte-mypst-dtl evnt-dtl">
                    <a href="#" onclick="changeChatUser(<?php echo $data->post_author; ?>)" data-id="<?php echo $data->post_author?>" data-toggle="modal" data-target="#ChatModal"><img src="<?php echo $frontend_assets ?>img/chat-3.png" alt="" width="30px"><div class="vndr-cmnt vndr-cmnt-img">
