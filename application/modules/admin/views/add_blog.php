                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo base_url('admin/imaginations/insertBlog') ?>">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <button type="button" onclick="window.location.href='http://dev.tulia.tech/admin/imaginations'" class="btn btn-danger ">CANCEL<div class="ripple-container"></div></button>
                                </div>
                            </div>
                        </form>
                    </div>
