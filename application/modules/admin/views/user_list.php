<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="text-right cht-btn">            
            <button type="button" class="btn btn-primary btn-raised" onclick="sendNOtification('admin/users','edit','<?php echo $user ?>')"><i class="fa fa-comments-o" aria-hidden="true"></i>
            </button>      
          </div>
          <!-- /.box -->
