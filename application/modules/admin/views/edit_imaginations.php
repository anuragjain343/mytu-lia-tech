                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo base_url('admin/imaginations/update') ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <textarea id="editor1" name="blog_disp" class="textarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $blogDetail->description?></textarea>
